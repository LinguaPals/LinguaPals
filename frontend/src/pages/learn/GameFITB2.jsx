...
import { routeForType, pickNextType, pickGivenLanguage, ROUTES, withSearch } from "../../lib/learn/routing.js";
...
export default function GameFITB2() {
  ...
  React.useEffect(() => {
    ...
    setError(null);
    setQ(null);
    getNextQuestion({ type: "fill", givenLang, settings })
      .then((next) => {
        if (!alive) return;
        setQ(next);
      })
